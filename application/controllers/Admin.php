		        	...
		        	foreach ($members as $member)
		          	{
						...
						$domain=explode("//",base_url())[1];
			            $nestedData['options'] = "<a href='/".$domain."admin/members/".$para1."/view_member/".$member->member_id."' id='demo-dt-view-btn' class='btn btn-primary btn-xs add-tooltip' data-toggle='tooltip' data-placement='top' title='".translate('view_profile')."' ><i class='fa fa-eye'></i></a>
