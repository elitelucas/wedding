                    ...
                    <div class="col-lg-6 col-md-10 ml-auto mr-auto">
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            <div class="form-body">
                                ...
                                <form class="form-default mt-4" id="register_form" method="post" action="<?php echo base_url()?>home/registration/sumit_lifestyle_family">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Family Values" ?></label>
                                                <select name="family_value" required class="form-control form-control-sm" data-placeholder="Choose a Family Value" >
													<option value="">Choose one</option>
													<?php 
														foreach ($family_value as $k => $v) {
															?>
																<option value="<?php echo $v->family_value_id; ?>"><?php echo $v->name;  ?></option>
															<?php
														}
													?>
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Family Type" ?></label>
                                                <select name="family_type" required class="form-control form-control-sm" data-placeholder="Choose a Family type" >
													<option value="">Choose one</option>
													<?php 
														foreach ($family_types as $k => $v) {
															?>
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Family Status" ?></label>
                                                <select name="family_status" required class="form-control form-control-sm" data-placeholder="Choose a Family status" >
													<option value="">Choose one</option>
													<?php 
														foreach ($family_status as $k => $v) {
															?>
																<option value="<?php echo $v->family_status_id; ?>"><?php echo $v->name;  ?></option>
															<?php
														}
													?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Mother tounge" ?></label>
                                                <select name="mother_tounge" required class="form-control form-control-sm" data-placeholder="Choose a mother tounge" >
													<option value="">Choose one</option>
													<?php 
														foreach ($mother_tounge as $k => $v) {
															?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Relative Caste" ?></label>
                                                <textarea type="text" required class="form-control form-control-sm" name="relative_caste" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "No. of Brothers" ?></label>
                                                 <select name="brothers" required class="form-control form-control-sm" data-placeholder="Choose your Number of Brothers" >
													<option value="">Choose one</option>
													<?php 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "No. of Brothers Married" ?></label>
                                                 <select name="brothers_married" required class="form-control form-control-sm" data-placeholder="Choose your Number of Brothers Married" >
													<option value="">Choose one</option>
													<?php 
														foreach ($brothers as $k => $v) {
															?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "No. of Sisters" ?></label>
                                                 <select name="sisters" required class="form-control form-control-sm" data-placeholder="Choose your Number of Sisters" >
													<option value="">Choose one</option>
													<?php 
														foreach ($sisters as $k => $v) {
															?>
																<option value="<?php echo $v->id; ?>"><?php echo $v->display;  ?></option>
															<?php
														}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "No. of Sisters Married" ?></label>
                                                 <select name="sisters_married" required class="form-control form-control-sm" data-placeholder="Choose your Number of Sisters Married" >
													<option value="">Choose one</option>
													<?php 
														foreach ($sisters as $k => $v) {
															?>
                                    ...
                                    <div class="row">
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Father Name" ?></label>
                                                <input type="text" required class="form-control form-control-sm" name="father_name" value="" >
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Father Occupation" ?></label>
                                                <input type="text" required class="form-control form-control-sm" name="father_occupation" value="" >
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Mother Name" ?></label>
                                                <input type="text" required class="form-control form-control-sm" name="mother_name" value="" >
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Mother Occupation" ?></label>
                                                <input type="text" required class="form-control form-control-sm" name="mother_occupation" value="" >
                                            </div>
                                        </div>
