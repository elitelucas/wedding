                    ...
                    <div class="col-lg-6 col-md-10 ml-auto mr-auto">
                        <div class="form-card form-card--style-2 z-depth-3-top">
                            <div class="form-body">
									...
									<div class="reg_pad1 fontreg">
										<div class="brdrb_1">
											<div class="fullwid txtc f15 tabone clearfix">
												...
												<a style="cursor:default" class="fl reg_active">Career Details</a>
                                ...
                                <form class="form-default mt-4" id="register_form" method="post" action="<?php echo base_url()?>home/registration/sumit_career_details">
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo translate('Education')?></label>
                                                <select name="degree" required class="form-control form-control-sm" data-placeholder="Select your education" >
													<option value="">Choose one</option>
													<?php 
														foreach ($height_degree as $k => $v) {
															?>
                                    ...
                                    <div class="row">
                                         <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Education Details" ?></label>
                                                <input type="text" required class="form-control form-control-sm" name="education_detail" value="">
                                            </div>
                                        </div>
                                    </div>
                                     ...
                                     <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Annual Income" ?></label>
                                                <select name="anual_income" required class="form-control form-control-sm" data-placeholder="Choose a Annual Income" >
													<option value="">Choose one</option>
													<?php 
														foreach ($anual_income as $k => $v) {
															?>
																<option value="<?php echo $v->id; ?>"><?php echo $v->display;  ?></option>
															<?php
														}
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Occupation" ?></label>
                                                <select name="occupation" required class="form-control form-control-sm" data-placeholder="Choose a Occupation" >
													<option value="">Choose one</option>
													<?php 
														foreach ($occupation as $k => $v) {
															?>
																<option value="<?php echo $v->occupation_id; ?>"><?php echo $v->name;  ?></option>
															<?php
														}
													?>
                                     ...
                                     <div class="row">
                                         <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Occupation Details" ?></label>
                                                <input type="text" required class="form-control form-control-sm" name="occupation_detail" value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Employed In" ?></label>
                                                <select name="employed" required class="form-control form-control-sm" data-placeholder="Choose a Employed In" >
													<option value="">Choose one</option>
													<?php 
														foreach ($employed as $k => $v) {
															?>
