                ...
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 <?php echo $this->Crud_model->get_type_name_by_id('mother_tounge', $get_member[0]->mother_tounge,'display');?>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control no-resize" name="area" value="<?php echo $basic_info_data[0]['area']?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
