            ...
            <div class="table-full-width">
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            <td class="td-label">
                                <span><?php echo translate('education_detail') ?></span>
                            </td>
                            <td>
                                <?php echo $get_member[0]->education_detail ?>
                            </td>
                            <td class="td-label">
                                <span><?php echo translate('occupation_detail') ?></span>
                            </td>
                            <td>
                                <?php echo $get_member[0]->occupation_detail ?> </td>
                        </tr>
                        <tr>
                            <td class="td-label">
    ...
    <div id="edit_education_and_career" style="display: none;">
        ...
        <form id="form_education_and_career" class="form-default" role="form">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="education_detail" class="text-uppercase c-gray-light"><?php echo translate('education_detail') ?></label>


                        <?php
                        echo $get_member[0]->education_detail;
                        ?>
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="occupation_detail" class="text-uppercase c-gray-light"><?php echo translate('occupation_detail') ?></label>

                        <?php
                        echo $get_member[0]->occupation_detail;
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
