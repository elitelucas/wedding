                ...
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php echo $this->Crud_model->multi_where('state','state_id', $get_member[0]->state, 'country_id', $get_member[0]->country,'name');?>
                            </td>
                        </tr>
                        <tr>
                            <td class="td-label">
                            ...
                            <td>
                            <?php echo $this->Crud_model->multi_where('city','city_id', $get_member[0]->city, 'state_id', $get_member[0]->state,'name');?>
                            </td>
                            <td class="td-label">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                            echo $this->Crud_model->select_new_html('india_city', 'city', 'display', 'edit', 'form-control form-control-sm selectpicker ', $get_member[0]->city, '', '', '');  
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        ...
                        <input type="text" class="form-control no-resize" name="postal_code" value="<?php echo $present_address_data[0]['postal_code']?>">
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
