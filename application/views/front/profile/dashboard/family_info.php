                ...
                <div class="col-md-6">
                    <div class="form-group has-feedback">
                        <label for="father" class="text-uppercase c-gray-light"><?php echo translate('father').' Occupation';?></label>
                         ...
                         <?php
                            echo $this->Crud_model->select_new_html('father_occupation', 'father_occupation', 'display', 'edit', 'form-control form-control-sm selectpicker', $get_member[0]->father_occupation, '', '', '');
                        ?>
                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        <div class="help-block with-errors"></div>
                    </div>
