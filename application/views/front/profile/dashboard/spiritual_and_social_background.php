    ...
    <div id="info_spiritual_and_social_background">
        <div class="card-inner-title-wrapper pt-0">
            <h3 class="card-inner-title pull-left">
                <?php echo translate('family_details')?>
            </h3>
            ...
            <div class="table-full-width">
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        <tr>
                            <td class="td-label">
                                <span><?php echo translate('family_values')?></span>
                            </td>
                            <td>
                            <?php echo $this->Crud_model->get_type_name_by_id('family_value', $get_member[0]->family_value);?>
                            </td>
                            <td class="td-label">
                                <span><?php echo translate('family_type')?></span>
                            </td>
                            <td>
                            <?php echo $this->Crud_model->get_type_name_by_id('family_type', $get_member[0]->family_type,'display');?>
                        ...
                        <tr>
                            ...
                            <td>
                            <?php echo $this->Crud_model->get_type_name_by_id('family_status', $get_member[0]->family_status);?>
                            </td>
                            <td class="td-label">
                                <span><?php echo translate('relative_caste')?></span>
                            </td>
                            <td>
                            <?php echo $get_member[0]->relative_caste?>
                          
                            </td>
                        </tr>
                        <tr>
                            <td class="td-label">
                                <span><?php echo translate('number_of_brothers')?></span>
                            </td>
                            <td>
                            <?php echo $this->Crud_model->get_type_name_by_id('brothers_sister_count', $get_member[0]->brothers, 'display');?>
                            ...
                            <td>
                            <?php echo $this->Crud_model->get_type_name_by_id('brothers_sister_count', $get_member[0]->brothers_married, 'display');?>                          
                            </td>
                        </tr>
                        <tr>
                            <td class="td-label">
                                <span><?php echo translate('number_of_sisters')?></span>
                            </td>
                            <td>
                            <?php echo $this->Crud_model->get_type_name_by_id('brothers_sister_count', $get_member[0]->sisters, 'display');?>                          
                            </td>
                            <td class="td-label">
                                <span><?php echo translate('sisters_married')?></span>
                            </td>
                            <td>
                            <?php echo $this->Crud_model->get_type_name_by_id('brothers_sister_count', $get_member[0]->sisters_married, 'display');?>                          
                          
                            </td>
                        </tr>
                        <tr>
                            <td class="td-label">
                                <span><?php echo translate('father_name')?></span>
                            </td>
                            <td>
                            <?php echo $get_member[0]->father_name;?>
                            </td>
                            <td class="td-label">
                                <span><?php echo translate('father_occupation')?></span>
                            </td>
                            <td>
                            <?php echo $get_member[0]->father_occupation?>
                          
                            </td>
                        </tr>
                        <tr>
                            <td class="td-label">
                                <span><?php echo translate('mother_name')?></span>
                            </td>
                            <td>
                            <?php echo $get_member[0]->mother_name;?>
                            </td>
                            <td class="td-label">
                                <span><?php echo translate('mother_occupation')?></span>
                            </td>
                            <td>
                            <?php echo $get_member[0]->mother_occupation?>
