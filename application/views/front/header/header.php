						            ...
						            <ul class="navbar-nav" data-hover="dropdown">
										...
										<li class="custom-nav dropdown">
											...
											<ul class="dropdown-menu" style="border: 1px solid #f1f1f1 !important;">
												...
												<li>
												<a class="dropdown-item <?php if(!empty($nav_dropdown)){if($nav_dropdown == 'advance-search'){?>nav_active_dropdown<?php }}?>" href="<?=base_url('advance-search')?>">
												<?php echo "Advance Search"?></a>
												</li>
											</ul>
										</li>
						                <li class="custom-nav dropdown">
						                ...
						                <?php /*echo translate('active_members') */?>Members</a>
						                <ul class="dropdown-menu" style="border: 1px solid #f1f1f1 !important;">
						                    <li class="dropdown dropdown-submenu">
						                    <li>
