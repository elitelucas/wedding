                ...
                <div class="col-lg-6 col-md-10 ml-auto mr-auto">
                    <div class="form-card form-card--style-2 z-depth-3-top">
                        <div class="form-body">
                                ...
                                <div class="reg_pad1 fontreg">
                                    <div class="brdrb_1">
                                        <div class="fullwid txtc f15 tabone clearfix">
                                            ...
                                            <a style="cursor:default" class="fl reg_active">Contact Details</a>
                            ...
                            <form class="form-default mt-4" id="register_form" method="post" action="<?php echo base_url() ?>home/registration/sumit_contact_details">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label font_light"><?php echo "Address" ?></label>
                                            <input required class="form-control form-control-sm" name="address" data-placeholder="Enter Address">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label font_light"><?php echo "Country" ?></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label font_light"><?php echo translate('State') ?></label>
                                            <select name="state" required class="form-control form-control-sm" data-placeholder="Choose a state">
                                                <option value="">Choose one</option>
                                                <?php
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label font_light"><?php echo "City" ?></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label font_light"><?php echo "Phone" ?></label>
                                            <input type="text" required class="form-control form-control-sm" name="phone" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label font_light"><?php echo "Residence" ?></label>
                                            <select name="residence" class="form-control form-control-sm" data-placeholder="Choose a residence">
                                                <option value="">Choose one</option>
                                                <?php
