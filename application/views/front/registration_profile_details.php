<!DOCTYPE html>
    ...
    <body>
                            ...
                            <div class="form-body">
                                ...
                                <form class="form-default mt-4" id="register_form" method="post" action="<?php echo base_url()?>home/registration/sumit_profile_details">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="caste" class="form-control form-control-sm" data-placeholder="Choose a caste" >
                                                    <option value="">Choose one</option>
                                                    <?php 
														foreach ($caste as $rk => $rv) {
															?>
																<option value="<?php echo $rv->caste_id; ?>"><?php echo $rv->caste_name;  ?></option>
															<?php
														}
													?>
												</select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label font_light"><?php echo "Subcaste" ?></label>
                                                <input type="text" class="form-control form-control-sm" name="sub_caste" value="<?php if(!empty($form_contents)){echo $form_contents['subcaste'];}?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row ">
        ...
        <script type="text/javascript">
            ...
            function fetchCaste() {
                var religion_id = $('select[name="religion"]').val();
                $.ajax({
                    url:"<?php echo base_url()?>home/get_dropdown_by_id_caste/caste/religion_id/"+religion_id,
                    method:"POST",
                    dataType: 'html', // request type html/json/xml
                    data:{table: 'caste', field:'religion_id', id: religion_id},
